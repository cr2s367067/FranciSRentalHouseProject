                ...
                ScrollView(.vertical, showsIndicators: true) {
                    Group {
                        VStack(spacing: 2) {
                            ...
                            Group {
                                ...
                                SpacerAtRightOfText(contain: "本契約於中華民國__年__月__日經承租人攜回審閱__日（契約審閱期間至少三日）")
                        ...
                        .padding(.top, 5)
                        VStack {
                            Text("        立契約書人承租人              ，出租人FranciS企業有限公司【為□所有權人□轉租人(應提示經原所有權人同意轉租之證明文件)】茲為房屋租賃事宜，雙方同意本契約條款如下：")
                    ...
                    Group {
                        ...
                        VStack(alignment: .leading, spacing: 5) {
                            ...
                            VStack(spacing: 6) {
                                Group {
                                    Text("租賃期間自民國  年  月  日起至民國  年  月  日止。") //租賃期間
                                }
                                .font(.system(size: 14, weight: .regular))
                            }
                        }
                        ...
                        VStack(alignment: .leading, spacing: 5) {
                            ...
                            VStack(spacing: 6) {
                                Group {
                                    Text("承租人每月租金為新臺幣(下同)___元整，每期應繳納1個月租金，並於每月1日前支付，不得藉任何理由拖延或拒絕；出租人亦不得任意要求調整租金。") //每月租金
                        ...
                        VStack(alignment: .leading, spacing: 5) {
                            ...
                            VStack(spacing: 6) {
                                Group {
                                    Text("擔保金（押金）由租賃雙方約定為1個月租金，金額為__元整(最高不得超過二個月房屋租金之總額)。承租人應於簽訂本契約之同時給付出租人。")//租金
                        ...
                        VStack(spacing: 6) {
                            Group {
                                ...
                                Group {
                                    ...
                                    LineWithSpacer(contain: "□由出租人負擔，若超過特定額度，超出部分由承租人負擔")
                                }
                                Group {
                                ...
                                Group {
                                    SubTitleView(subTitleName: "五、網路費：")
                                    LineWithSpacer(contain: "□由出租人負擔，若超過特定額度，超出部分由承租人負擔。")
                                }
                            }
                            .font(.system(size: 14, weight: .regular))
                    ...
                    VStack(alignment: .leading, spacing: 5) {
                        ...
                        VStack(spacing: 6) {
                            Group {
                                ...
                                Text("承租人在未經出租人同意下不得將本房屋之全部或一部分轉租、出借或 以其他方式供他人使用，或將租賃權轉讓於他人。承租人得在找到承讓人承租後，向出租人申請，經同意後得將房屋轉讓予新租客承租，另外訂金再扣除轉讓費等其他費用後返回原承租人，在新承租人須繳付，一個月份之訂金。")
                            }
                            .font(.system(size: 14, weight: .regular))
                        }
                    }
                    ...
                    Group {
                        ...
                        VStack(alignment: .leading, spacing: 5) {
                            ...
                            VStack(alignment: .leading, spacing: 5) {
                                ...
                                VStack(spacing: 6) {
                                    Group {
                                        Text("本契約於期限屆滿前，租賃雙方不得終止租約。依約定得終止租約者，租賃之一方應於一個月前通知他方。一方未為先期通知而逕行終止租約者，應賠償他方1個月(最高不得超過一個月)租金額之違約金。")
                            ...
                            Group {
                                ...
                                VStack(alignment: .leading, spacing: 5) {
                                    ...
                                    VStack(spacing: 6) {
                                        Group {
                                            ...
                                            Text("一、遲付租金之總額達一個月之金額，並經出租人定相當期限催告，承租人仍不為支付。")
                                ...
                                VStack(alignment: .leading, spacing: 5) {
                                    ...
                                    VStack(spacing: 6) {
                                        Group {
                                            Text("除本契約另有約定外，出租人與承租人雙方相互間之通知，以郵寄為之者，應以本契約所記載之地址為準；並得以電子郵件、簡訊與其公司開發之程式的方式為之(無約定通知方式者，應以郵寄為之)；如因地址變更未通知他方，致通知無法到達時（包括拒收），以他方第一次郵遞或通知之日期推定為到達日。")
                                        }
                                        .font(.system(size: 14, weight: .regular))
                                    }
                                }
