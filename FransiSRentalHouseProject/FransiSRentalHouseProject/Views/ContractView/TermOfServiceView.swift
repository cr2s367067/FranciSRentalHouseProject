            ...
            VStack {
                ScrollView(.vertical, showsIndicators: true) {
                    Group {
                        ...
                        .padding(.top, 5)
                        VStack {
                            Text("若下載、安裝、複製、存取或使用本軟體，即表示您同意本使用者授權合約的條款。如果您代表他人、公司或其他法定實體接受這些條款，則您即聲明並保證您擁有完全的授權，可使該人員、公司或法定實體受這些條款的約束。若您不同意這些條款:")
                                .font(.system(size: 15, weight: .regular))
                            Text("請勿下載、安裝、複製、存取或使用本軟體；並應及時將本軟體和授權證明一併退還至其提供方")
                                .font(.system(size: 15, weight: .regular))
                        }
                        .padding(.top, 5)
                        .padding(.horizontal)
                    ...
                    Group {
                        ...
                        VStack(alignment: .leading, spacing: 5) {
                            ...
                            VStack(spacing: 6) {
                                Group {
                                    Text("根據本合約的條款與條件，FranciS 特此向您授予非獨占、不可轉讓的權利，使用軟體包括下載、安裝和存取軟體。但不包含，其物件碼和原始程式碼 (無論是否提供給您) 為 FranciS 的高度機密。FranciS (或其授權人)獨家擁有並保留所有與軟體相關之權利、所有權和利益，且您不得行使上述任何權利、所有權和利益，包括但不限於，所有與軟體相關之智慧財產權，在本合約中授予您的有限軟體使用授權除外。本合約並非銷售合約，且根據本合約，軟體之權利、智慧財產權或所有權均不會轉移予您。您確認並同意，軟體、用於開發或納入軟體的所有創意、方法、演算法、公式、程序和概念、所有未來更新和升級，及所有其他改進、修改、更正、錯誤修復、熱修復、修補程式、修改、增強、發佈、升級、原則和資料庫更新，以及其他與軟體相關的更新， 以及前述任何一項的所有衍生作品和複本，均為 FranciS 的商業秘密和專有財產，並且對 FranciS 而言具有巨大的商業價值。")
                                }
                                .font(.system(size: 14, weight: .regular))
                            }
                        }
                        ...
                        VStack(alignment: .leading, spacing: 5) {
                            ...
                            VStack(spacing: 6) {
                                Group {
                                    ...
                                    Text("FranciS 租賃管理科技有限公司使用者授權合約 (2022 年 7 月)")
                                }
                                .font(.system(size: 14, weight: .regular))
                            }
                        }
