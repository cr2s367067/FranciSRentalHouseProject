...
class FirestoreForTextingMessage: ObservableObject {
    ...
    func sendingMessage(text: String, sendingImage: String?, senderProfileImage _: String, senderDocID: String, sendingTimestamp: Date = Date(), chatRoomUID: String) async throws {
    ...
    func fetchChatingMember(userDocID: String) async throws {
        ...
        contactMember = document.compactMap { queryDocumentSnapshot in
            let result = Result {
...
extension FirestoreForTextingMessage {
    ...
    func fetchChatCenter() async throws {
        ...
        chatManager = document.compactMap { queryDocumentSnapshot in
            let result = Result {
