...
class FetchFirestore: ObservableObject {
    ...
    func uploadUserInformation(uidPath: String, id: String , firstName: String, lastName: String, PhoneNumber: String, dob: Date, address: String, town: String, city: String, zip: String, country: String, gender: String, userType: String) {
        let userInfo = UserDataModel(id: id, firstName: firstName, lastName: lastName, phoneNumber: PhoneNumber, dob: dob, address: address, town: town, city: city, zip: zip, country: country, gender: gender, userType: userType)
        do {
    ...
    func updateUserInformation(uidPath: String, id: String , firstName: String, lastName: String, PhoneNumber: String, dob: Date, address: String, town: String, city: String, zip: String, country: String, gender: String, userType: String) {
        let userInfo = UserDataModel(id: id, firstName: firstName, lastName: lastName, phoneNumber: PhoneNumber, dob: dob, address: address, town: town, city: city, zip: zip, country: country, gender: gender, userType: userType)
        do {
            try db.collection("users").document(uidPath).setData(from: userInfo)
        } catch {
    ...
    func fetchData(uidPath: String) {
        ...
        userRef.addSnapshotListener { querySnapshot, error in
            ...
            self.fetchData = data.map { (dataSnapShot) -> UserDataModel in
                ...
                return UserDataModel(id: id, firstName: firstName, lastName: lastName, phoneNumber: phoneNumber, dob: dob, address: address, town: town, city: city, zip: zip, country: country, gender: gender, userType: userType)
            }
        }
    }
