...
struct RoomDMExternal: Codable {
    @DocumentID var roomUID: String?
...
//struct ContractExternal: Codable {
...
struct RentedRoom: Codable {
    ...
    var contract: HouseContract?
    var depositFee: Int
    @ServerTimestamp var paymentDate: Timestamp?
    
    init(rentedRoomUID: String, rentedProvderUID: String, contract: HouseContract? = nil, depositFee: Int, paymentDate: Timestamp? = nil) {
...
extension RentedRoom {
    static let empty = RentedRoom(rentedRoomUID: "", rentedProvderUID: "", contract: nil, depositFee: 0)
}
